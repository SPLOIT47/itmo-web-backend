...
exports.FeedModule = FeedModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [feed_service_1.FeedService, feed_repository_1.FeedRepository, feed_source_repository_1.FeedSourceRepository],
        exports: [feed_repository_1.FeedRepository, feed_source_repository_1.FeedSourceRepository],
    })
], FeedModule);
