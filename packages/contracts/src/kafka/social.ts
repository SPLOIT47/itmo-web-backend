...
export type FriendAddedEvent = SocialEventEnvelope<
    SocialEventType.FRIEND_ADDED,
    FriendAddedPayload
>;

export type FriendRemovedEvent = SocialEventEnvelope<
    SocialEventType.FRIEND_REMOVED,
    FriendRemovedPayload
>;

export type CommunitySubscribedEvent = SocialEventEnvelope<
    SocialEventType.COMMUNITY_SUBSCRIBED,
    CommunitySubscribedPayload
>;

export type CommunityUnsubscribedEvent = SocialEventEnvelope<
...
export type SocialEvent =
    | FriendAddedEvent
    | FriendRemovedEvent
    | CommunitySubscribedEvent
    | CommunityUnsubscribedEvent;
